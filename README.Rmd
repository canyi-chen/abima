...
This example shows the example for using abYlm.Mglm and how to setup covariates_cfder that you would to condition on. 
...
This exmaple shows that the adaptive bootstrap can control the type I error under the singular null hypothesis.
